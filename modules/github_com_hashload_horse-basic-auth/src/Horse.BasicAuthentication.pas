  ...
  try
    ...
    try
      ...
      begin
        ...
        UserSession.Nome := LBasicAuthenticationDecode.Strings[0];
        UserSession.Senha := LBasicAuthenticationDecode.Strings[1];
        Req.Sessions.SetSession(TUserSession, UserSession);
      end
      else
      begin
