...
//    .Get('/:num_pagina/:qtd_por_pagina', TControllerProdutos.Get)
...
//  APP.Group
//    .Prefix('/inventario')
//    .Post('/', TControllerInventario.Post)
//    .Put('/:id_nota', TControllerInventario.Put)
//    .Delete('/:id_nota', TControllerInventario.Delete);
//
//  APP.Group
//    .Prefix('/transferencia')
//    .Post('/', TControllerTransferencia.Post)
//    .Put('/:id_nota', TControllerTransferencia.Put);
